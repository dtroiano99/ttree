...
void MyClass::Loop()
{
  ...
  //Long64_t nentries = b_lep_pt->GetEntries();
   ...
   TH1F *h_4l_m_pass[99] = {};
   TH1F *h_NVPH  = new TH1F("h_NVPH","number of valid pixel hits", 14, -0.5,13.5);
   ...
   TH1F *h_KINK  = new TH1F("h_KINK","track of kinks", 61, -0.5,60.5);
   ...
   h_NVPH->GetYaxis()->SetTitle("Events");
   h_NVPH->GetXaxis()->SetTitle("number of valid pixel hits");
   h_NVPH->GetXaxis()->CenterTitle();
   h_TLWM->SetLineColor(2);
   h_TLWM->GetYaxis()->SetTitle("Events");
   h_TLWM->GetXaxis()->SetTitle("tracker layers with measurement");
   h_TLWM->GetXaxis()->CenterTitle();
   h_C2LP->SetLineColor(2);
   h_C2LP->GetYaxis()->SetTitle("Events");
   h_C2LP->GetXaxis()->SetTitle("#Chi^{2} local position");
   h_C2LP->GetXaxis()->CenterTitle();
   h_KINK->SetLineColor(2);
   h_KINK->GetYaxis()->SetTitle("Events");
   h_KINK->GetXaxis()->SetTitle("tracks kink");
   h_KINK->GetXaxis()->CenterTitle();
   h_NOMS->SetLineColor(2);
   h_NOMS->GetYaxis()->SetTitle("Events");
   h_NOMS->GetXaxis()->SetTitle("number of matched stations");
   h_NOMS->GetXaxis()->CenterTitle();
   h_VAFR->SetLineColor(2);
   h_VAFR->GetYaxis()->SetTitle("Events");
   h_VAFR->GetXaxis()->SetTitle("valid fraction");
   h_VAFR->GetXaxis()->CenterTitle();
   h_NOC2->SetLineColor(2);
   h_NOC2->GetYaxis()->SetTitle("Events");
   h_NOC2->GetXaxis()->SetTitle("normalised #Chi^{2}");
   h_NOC2->GetXaxis()->CenterTitle();
   h_NVMH->SetLineColor(2);
   h_NVMH->GetYaxis()->SetTitle("Events");
   h_NVMH->GetXaxis()->SetTitle("number of valid muon hits");
   h_NVMH->GetXaxis()->CenterTitle();
   TObjArray Hlist(0);
   Hlist.Add(h_NVPH);
   Hlist.Add(h_TLWM);
   Hlist.Add(h_C2LP);
